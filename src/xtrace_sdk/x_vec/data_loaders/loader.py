...
from xtrace_sdk.x_vec.utils.xtrace_types import Chunk, DocumentCollection, EncryptedDB
...
class DataLoader:
    ...
    async def dump_db(self, db: EncryptedDB, index: list[list[int]], kb_id: str, concurrent: bool = False) -> list[dict]:
